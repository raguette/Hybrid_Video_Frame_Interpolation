...
#     # Optional: warm-start SuperGenerator from a previous run
#     if args.pretrain_generator is not None:
#         ckpt = torch.load(args.pretrain_generator, map_location=device)
#         # ckpt may be a raw state_dict (best_G.pth) or a full checkpoint dict
